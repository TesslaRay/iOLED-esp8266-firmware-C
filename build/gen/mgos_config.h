 ...
 * Command: /mongoose-os/fw/tools/gen_sys_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.13.1/apps/demo-c/esp8266/build_contexts/build_ctx_418204835/build/gen/ /mongoose-os/fw/src/mgos_debug_udp_config.yaml /data/fwbuild-volumes/2.13.1/apps/demo-c/esp8266/build_contexts/build_ctx_418204835/build/gen/mos_conf_schema.yml
 */
...
static inline void mgos_sys_config_set_rpc_ws_ssl_cert(const char *val) { mgos_config_set_rpc_ws_ssl_cert(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_rpc_ws_ssl_key(const char *val) { mgos_config_set_rpc_ws_ssl_key(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_rpc_ws_ssl_ca_cert(const char *val) { mgos_config_set_rpc_ws_ssl_ca_cert(&mgos_sys_config, val); }
...
static inline void mgos_sys_config_set_dash_ssl_cert(const char *val) { mgos_config_set_dash_ssl_cert(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_dash_ssl_key(const char *val) { mgos_config_set_dash_ssl_key(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_dash_ssl_ca_cert(const char *val) { mgos_config_set_dash_ssl_ca_cert(&mgos_sys_config, val); }
